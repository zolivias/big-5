...
import { emptyActivityPreferences, preferenceQuestions, setMultiplePreference } from "../../lib/preferences";
...
export function PreferencesClient() {
  ...
  function choose(key: keyof ActivityPreferences, value: string, multiple = false, checked = true) {
    setNotice("");
    setAnswers((current) => {
      ...
      const next = setMultiplePreference(key as "benefits" | "constraints" | "interests", values, value, checked);
