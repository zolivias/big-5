...
import { describePreferenceMatch, getRecommendations, goals } from "../../lib/recommendations";
...
export function ToolkitClient() {
  ...
  const items = useMemo(() => profile ? getRecommendations(profile.scores, profile.goal, profile.activityPreferences).filter((item) => !profile.dismissed.includes(item.id)) : [], [profile]);
