    ...
    <PageShell>
      <section className="hero">
        <div className="hero-copy">
          ...
          <p className="hero-lede">Find evidence-reviewed activities that fit your goals, interests, time, and comfort level. The assessment helps you begin. The toolkit is where you put what you learn into practice.</p>
